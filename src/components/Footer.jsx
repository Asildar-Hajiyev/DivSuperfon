...
function Footer() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 p-4 md:p-8">
    {/* Logo və Telefon - mobildə gizli */}
    <div className="flex flex-col gap-14">
      <img className="w-[180px] hidden md:flex" src={Logo} alt="" />
    ...
    <div>
      ...
      <ul className="pt-2">
        {data.map((item) => (
          <li className="py-1 text-gray-500 cursor-pointer hover:underline" key={item.id}>
            {item.name}
          </li>
        ))}
      </ul>
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3">
        <h2 className="text-[#001623] text-xl font-semibold">Bizi izləyin</h2>
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-[#001623] text-xl font-semibold">Yeniliklərdən xəbər alın</h2>
        ...
        <div className="flex items-center border rounded-sm bg-white border-gray-400 overflow-hidden w-full">
          ...
          />
          <button className="bg-[#001623] px-4 py-4 text-white text-sm whitespace-nowrap hover:bg-[#002a3d] transition-all duration-200">
            Abunə ol
          </button>
        </div>
      </div>
  ...
  <div className="border-t border-gray-300 px-4 md:px-8 py-4">
    <ul className="flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-gray-600">
      <li className="text-center">© 2019-2026 Superfon. Bütün hüquqlar qorunur</li>
      ...
      <li className="text-center">
        Sayt <span className="font-semibold text-[#001623]">Asildar</span> tərəfindən hazırlandı
      </li>
    </ul>
  </div>
</footer>
